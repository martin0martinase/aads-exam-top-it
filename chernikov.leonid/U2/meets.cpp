...
void chernikov::initMeets(MeetsByPerson &meets)
{
  initHashTable(meets);
}

void chernikov::destroyMeets(MeetsByPerson &meets)
{
...
chernikov::MeetList *chernikov::getMeets(MeetsByPerson &meets, std::size_t personId)
{
  if (!hasInHashTable(meets, personId))
  {
    return nullptr;
